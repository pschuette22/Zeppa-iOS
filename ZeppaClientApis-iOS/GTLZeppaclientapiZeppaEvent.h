...
@property (nonatomic, retain) NSArray *attendeeRelationships;  // of GTLZeppaclientapiZeppaEventToUserRelationship
@property (nonatomic, retain) NSArray *comments;  // of GTLZeppaclientapiEventComment
