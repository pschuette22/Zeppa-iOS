        ...
        dispatch_async(self.ioQueue, ^{
            ...
            if (data) {
                if (![_fileManager fileExistsAtPath:_diskCachePath]) {
                    ...
                    [[NSFileManager defaultManager] addSkipBackupAttributeToItemAtURL:[NSURL fileURLWithPath:_diskCachePath]];
                }

                [_fileManager createFileAtPath:[self defaultCachePathForKey:key] contents:data attributes:nil];
                [[NSFileManager defaultManager] addSkipBackupAttributeToItemAtURL:[NSURL fileURLWithPath:[self defaultCachePathForKey:key]]];
            }
        });
    }
}
    ...
    dispatch_async(self.ioQueue, ^{
        ...
        [_fileManager createDirectoryAtPath:self.diskCachePath
                withIntermediateDirectories:YES
                                 attributes:nil
                                      error:NULL];
        [[NSFileManager defaultManager] addSkipBackupAttributeToItemAtURL:[NSURL fileURLWithPath:self.diskCachePath]];
